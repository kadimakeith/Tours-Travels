...
<body >    
    ...
    <section class="container-fluid offerhero">
        <div class="container text-center vertical-center">
            <h1 style='color:#14a9e6; top:50%; '> SERVICES </h1>
        </div>
    ...
    <section class="container-fluid white-bg " style='margin-top:30px'>
        <div class="container">
            <div class="row">
    
                <div class="col-sm-12 col-md-12 col-lg-6 order-lg-1 copy-left">
                    
                    <p><span style="font-size: 18px;"><strong>To be the most sought after travel agency, providing services to all sectors of the 
                        business community and individuals. 
                        <span style="display: inline-block;">®</span></strong></span></p>
                    <ul>
                        <li>Inbound & Outbound Tours and Safari</li>
                        <li>Holiday Packages</li>
                        <li>Pilgrimmage Packages</li>
                        <li>Cruise Packages</li>
                        <li>Visas</li>
                        <li>Medical Tourism</li>
                    </ul>
                    <p><a class="btn btn-green" href="contact.html">How Can We Help?</a> <a href='mailto:info@madronetravel.co.ke'><button class="btn btn-primary"  target="_blank" rel="noopener">Schedule a Meeting</button></a>
                </div><!-- /.columns -->
    
                <div class="col-sm-12 col-md-12 col-lg-6 order-lg-2 video-responsive">
                    <div class="row">
                        <!-- 16:9 aspect ratio -->
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/gTEXJsw62iU" width="300" height="150" allowfullscreen="allowfullscreen"></iframe>
                        </div>
                    </div>
                </div><!-- /.columns -->
    ...
    <section class="p-7 bg-light">
        <div class="container-fluid padding core">
            <div class="wrap">
            ...
            <div class="row padding">
                ...
                <div class="col-sm-3">
                    <div class="card" data-aos="fade-up" >
                        <img class='card-img-top' style='height: 290px;' src='./images/plane.jpg'/>
                        <div class="overlay">
                            <div class="text">Our reservations team offers both international and domestic tickets. The team is very efficient and informative to ensure our clients are handled professionally and advised accordingly the travel. Bookings are done via phone or e-mails. </div>
                         </div>
                        <div class="card-body">
                            <h4 class="card-title text-center" >Air travel</h4>
                            <p class='text-center'style='font-size: 12px'> Learn More...</p>
                        </div> 
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card" data-aos="fade-up">
                        <img class='card-img-top' style='height: 290px;' src='https://st4.depositphotos.com/2870309/28549/i/600/depositphotos_285496538-stock-photo-kenyan-shillings-black-wallet.jpg'/>
                        <div class="overlay">
                            <div class="text">The company will negotiate with the airlines whenever our clients have a group / students travelling to obtain reduced air fares</div>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title text-center">Group / Student fares</h4>
                            <p class='text-center'style='font-size: 12px'> Learn More...</p>
                        </div> 
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card" data-aos="fade-up">
                        <img class='card-img-top' style='height: 290px;' src='./images/motel.jpg'/>
                        <div class="overlay">
                            <div class="text">
                                We have special contract rates with most hotels and lodges in Kenya and can assist with any reservations for both residents and non-residents
                            </div>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title text-center" >Hotels</h4>
                            <p class='text-center'style='font-size: 12px'> Learn More...</p>
                        </div> 
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card" data-aos="fade-up">
                        <img class='card-img-top' style='height: 290px;' src='./images/charters.jpg'/>
                        <div class="overlay">
                            <div class="text">
                                As a company, we have good contacts with the aviation industry, and can thereby negotiate charters for domestic and regional destinations at discounted rates
                            </div>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title text-center">Charters</h4>
                            <p class='text-center'style='font-size: 12px'> Learn More...</p>
                        </div> 
                    </div>
                </div>
            ...
            <div class='row padding'>
                ...
                <div class="col-sm-3">
                    <div class="card" data-aos="fade-up" >
                        <img class='card-img-top' style='height: 290px;' src='./images/emergency.jpg'/>
                        <div class="overlay">
                            <div class="text">We work 24hours a day. We provide telephone numbers of staffs that can be reached any time for any emergency that can occur. Any travel issue that occur past office hours can be dealt with by calling these numbers </div>
                         </div>
                        <div class="card-body">
                            <h4 class="card-title text-center">Emergency</h4>
                            <p class='text-center'style='font-size: 12px'> Learn More...</p>
                        </div> 
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card" data-aos="fade-up">
                        <img class='card-img-top' style='height: 290px;' src='./images/courtesy.jpg'/>
                        <div class="overlay">
                            <div class="text">We provide meet and greet services if required, where members of our staff will assist arriving or departing passengers with airport formalities </div>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title text-center">Courtesy</h4>
                            <p class='text-center'style='font-size: 12px'> Learn More...</p>
                        </div> 
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card" data-aos="fade-up">                              
                        <img class='card-img-top' style='height: 290px;' src='./images/flyer.jpg'/>
                        <div class="overlay">
                            <div class="text" style ='font-size: 13px'>
                                We ensure that our clients enroll with the frequent flyer program with preferred airlines. Some of the benefits that comes with this program include: upgrades, lounge services, selection of seats, extra baggage, waitlist priority on fully booked flights, free tickets on mileage.
                            </div>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title text-center" style='font-size:17px'>Frequent Flyer Enrollment</h4>
                            <p class='text-center'style='font-size: 12px'> Learn More...</p>
                        </div> 
                    </div>
                </div>
                <div class="col-sm-3">
                    <div class="card" data-aos="fade-up">
                        <img class='card-img-top' style='height: 290px;' src='./images/safarihero.jpg'/>
                        <div class="overlay">
                            <div class="text">
                                The company has travel insurance that it offers to its clients when requested.
                            </div>
                        </div>
                        <div class="card-body">
                            <h4 class="card-title text-center">Travel insurance</h4>
                            <p class='text-center'style='font-size: 12px'> Learn More...</p>
                        </div> 
                    </div>
                </div>
    ...
    <section class="container-fluid offerhero2">
